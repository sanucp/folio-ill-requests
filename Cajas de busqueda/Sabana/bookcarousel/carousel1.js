		...
		for(var i=0;i<3;i++) {
			for(var j=0;j<bookCount;j++) {
				...
				if (is_valid_isbn(isb)) {
					...
					returnString += '<img style="border: 0px; width: 80px; height: 120px;" alt="' + bookList[j].ISBN + '_image" src="http://smallcontent.ebsco-content.com/branding/s1229929/covers/' + bookList[j].ISBN + '.jpg" />';
