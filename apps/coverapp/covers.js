          ...
          jQuery(".custom-link", jQuery(this)).each(function() {
            ...
            if (cat1 == "cat06493a") {
              ...
              if (regExp.test(bookjacketlink)) {
                ...
                var url_i =
                  "https://unisabana.hosted.exlibrisgroup.com/OAI?verb=GetRecord&identifier=oai:il-aleph03:CNA01-";
                var url_r = "&metadataPrefix=marc21";
                //alert (recdIdentifer);
                $.ajax({
                  type: "POST",
                  dataType: "json",
                  url:
                    "https://gss.ebscohost.com/anavarro/script/test/algo.php",
                  data: {
                    id: recdIdentifer,
                    int: url_i,
                    res: url_r,
