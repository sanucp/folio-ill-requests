...
$result = curl_exec ($ch);
$campo = 'http://unisabana22.gsl.com.mx:80/F?func=service';
...
$imagen = "http://unisabana22.gsl.com.mx".substr($imagen1, 0, $pos_fin);
if ($imagen == "http://unisabana22.gsl.com.mx") $imagen = "";
curl_close ($ch);
//echo ($imagen);
