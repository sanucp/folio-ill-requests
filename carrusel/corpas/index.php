    ...
    <div class="carrusel">
        <ul class="bloque-imagenes">
            <?php foreach ($libros as $l1){    
                echo "<li>";
                echo "<a href='https://accessmedicina.mhmedical.com/book.aspx?bookid=" . $l1["ID"]."' target='_blank'>" . "<img src='http://imageserver.ebscohost.com/branding/s1202090/covers/" . $l1["ISBN"] . ".jpeg' /></a>" ;
                echo "</li>";
            }
            ?>
        </ul>
